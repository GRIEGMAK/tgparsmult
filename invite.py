...
def inviter(file_name, target_group_id, start_value, api_id, api_hash, phone, invite_count, mode, target_group):
    import time, os
    finished = 0
    try:
...
for cpass in csv_accounts:
    ...
    try:
        ...
        setup.close()
        start_value = 0
    inviter(input_file, target_group_id, start_value, api_id, api_hash, phone, invite_count, mode, target_group)
